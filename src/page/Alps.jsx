...
function Alps() {
  ...
  function Mark(Name) {
    return () => {
      const component = document.getElementById("AlpsComponent");
      ...
      <div id="AlpsComponent">
        ...
        <div className="subAll">
          ...
          <div className="subText">
            <h1>Advanced Liquid Processing System</h1><br />
            <p>
            ...
            <img src={process.env.PUBLIC_URL + "/img/AlpsWater.png"} style={{ borderRadius: '30px' }} alt="" />
            <li><span className="words" onClick={Mark("suso")}>삼중수소</span>: 세 개의 수소 원자로 이루어진 분자</li>
            <br />

            <h3>
              왜 <span className="suso">삼중수소</span>를 제거할 수 없는가?
            </h3><br />
            ...
            <img src={process.env.PUBLIC_URL + "/img/AlpsClean.png"} alt="" />
            <li><span className="words" onClick={Mark("suso")}>삼중수소</span>: 세 개의 수소 원자로 이루어진 분자</li>
            <li><span className="words" onClick={Mark("dongwi")}>동위원소</span>: 같은 원소이지만 중성자의 수가 서로 다른 원자의 형태를</li>
            <li><span className="words" onClick={Mark("hakyun")}>핵융합 시설</span>: 두 가지 가벼운 원자핵이 융합하여 에너지를 생성하는 시설</li>
            <br />
            <h3>
              ALPS 처리수의 관리
            </h3><br />
            ...
            <img src={process.env.PUBLIC_URL + "/img/AlpsProcess.png"} alt="" />
